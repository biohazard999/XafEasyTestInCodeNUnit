...
<%@ Register Assembly="DevExpress.Web.v19.1" Namespace="DevExpress.Web" TagPrefix="dxrp" %>

<%@ Register Assembly="DevExpress.Web.v19.1" Namespace="DevExpress.Web" TagPrefix="dxsp" %>
<%@ Register Assembly="DevExpress.Web.v19.1" Namespace="DevExpress.Web" TagPrefix="dxge" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v19.1" Namespace="DevExpress.ExpressApp.Web.Templates.ActionContainers" TagPrefix="cc2" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v19.1" Namespace="DevExpress.ExpressApp.Web.Controls" TagPrefix="cc4" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v19.1" Namespace="DevExpress.ExpressApp.Web.Templates.Controls" TagPrefix="tc" %>
...
<body onload="OnLoad()"  class="HorizontalTemplate">
	...
	<dxge:ASPxGlobalEvents ClientSideEvents-EndCallback="CallbackHandler" ID="GlobalEvents" runat="server" />
    ...
    <cc2:NavigationTabsActionContainer ID="NavigationTabsActionContainer" runat="server" ContainerId="ViewsNavigation" CssClass="NavigationTabsActionContainer">
        <SpaceAfterTabsTemplate>
         ...
         <dxsp:ASPxSplitter ID="Splitter" runat="server" Width="100%" ShowCollapseBackwardButton="True" SaveStateToCookiesID="SeparatorPos" SaveStateToCookies="True" ClientInstanceName="splitter">
             <Panes>
                 <dxsp:SplitterPane Name="Left" Size="100%" PaneStyle-Paddings-Padding="1px" PaneStyle-BorderLeft-BorderStyle="None">
                     <ContentCollection>
                 ...
                 <dxsp:SplitterPane Name="Content" Size="100%" PaneStyle-Paddings-Padding="0px" PaneStyle-BorderRight-BorderStyle="None" ScrollBars="None">
                     <ContentCollection>
                         <dxsp:SplitterContentControl ID="SplitterContentControl3" runat="server">
                            ...
                            <div id="footer2" style="display:block;width:1px; height:1px"/>                            
                         </dxsp:SplitterContentControl>
                     </ContentCollection>
                 </dxsp:SplitterPane>
             </Panes>
