...
namespace TestApplication.Web {
    public partial class TestApplicationAspNetApplication : WebApplication {
        ...
        private void TestApplicationAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new TestApplication.Module.TestApplicationModule();
            this.module4 = new TestApplication.Module.Web.TestApplicationAspNetModule();
            ...
            // 
            // TestApplicationAspNetApplication
            // 
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.TestApplicationAspNetApplication_DatabaseVersionMismatch);
